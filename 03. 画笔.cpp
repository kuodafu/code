...
//    HPEN hPen2 = ExtCreatePen(penStyle, penWidth, &logBrush, 0, 0);
//
//#endif
//
//
...
//        lb.lbHatch = uHatch[i];
//        hPen = ExtCreatePen(PS_GEOMETRIC, 20, &lb, 0, NULL);
//        hPenOld = SelectObject(hdc, hPen);
//        MoveToEx(hdc, rc.left + (i * 40), rc.top, NULL);
//        LineTo(hdc, rc.left + (i * 40), rc.bottom);
//        SelectObject(hdc, hPenOld);
//        DeleteObject(hPen);
//    }
//
